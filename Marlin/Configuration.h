...
#define STRING_CONFIG_H_AUTHOR "(Doob, Tevo Tornado V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Doobs Tornado"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 399.3, 420 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -12, -1.20 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 20), (Y_MAX_POS - 20), 40 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 173  // Initial brightness (0-255)
